        ...
        binding.llForgotpassReq.setOnClickListener {
            ...
            if (isValidLogin()) {
                ...
                if (NetworkUtils.isConnectedToNetwork(requireContext())) {
                    Log.d(
                        "forgotpass",
                        "onClicked: " + com.example.engu_pension_verification_application.model.request.InputForgotPassword(
                            email_Phn
                        )
                    )
                    forgotPasswordViewModel.doForgotPass(
                        com.example.engu_pension_verification_application.model.request.InputForgotPassword(
                            email_Phn
                        )
                    )
                } else {
