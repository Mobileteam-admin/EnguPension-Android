...
data class SwiftCodeVerificationResponse(
    ...
    data class Detail(
        ...
        @field:SerializedName("swift_code_response") val swiftCodeResponse: SwiftCodeResponse? = null,
        ...
        data class SwiftCodeResponse(
            ...
            @field:SerializedName("branch_name") val branchName: String? = null,
            @field:SerializedName("country_name") val countryName: String? = null,
            @field:SerializedName("city_id") val cityId: String? = null,
            @field:SerializedName("city_name") val cityName: String? = null,
            @field:SerializedName("bank_id") val bankId: String? = null,
