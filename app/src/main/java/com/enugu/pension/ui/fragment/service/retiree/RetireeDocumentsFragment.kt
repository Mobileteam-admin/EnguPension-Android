...
import com.enugu.pension.util.DocumentFragmentUtils
    ...
    private fun populateViews() {
        RetireeUserDocRetrive?.let { retireeUserDoc ->
            if (!retireeUserDoc.idCardFileUrl.isNullOrEmpty()) {
                ...
                // Mandatory documents
                DocumentFragmentUtils.setDocumentView(retireeUserDoc.idCardFileUrl, binding.retireeIdCardBtnGreenView, binding.cvRetireeIdCardDoc, binding.tvRetireeIdCardDocFilename, binding.imgRetireeIdCardDocClose, binding.llRetireeIdCardDocUploadprogress, binding.llRetireeIdCardDocPercentage, binding.pbRetireeIdCardDoc)
                // Optional documents
                DocumentFragmentUtils.setDocumentViewIfPresent(retireeUserDoc.passportPhotoFileUrl, binding.retireePassportPhotoBtnGreenView, binding.cvRetireePassportPhotoDoc, binding.tvRetireePassportPhotoDocFilename, binding.imgRetireePassportPhotoDocClose, binding.llRetireePassportPhotoDocUploadprogress, binding.llRetireeAppPassportPhotoDocPercentage, binding.pbRetireePassportPhotoDoc)
                DocumentFragmentUtils.setDocumentViewIfPresent(retireeUserDoc.applicationFormFileUrl, binding.retireeAppBtnGreenView, binding.cvRetireeApplicationFormDoc, binding.tvRetireeAppFormFilename, binding.imgRetireeAppFormClose, binding.llRetireeAppFormUploadprogress, binding.llRetireeAppFormPercentage, binding.pbRetireeAppForm)
                DocumentFragmentUtils.setDocumentViewIfPresent(retireeUserDoc.monthlyArrearsPaymentAppointmentFileUrl, binding.retireeAppointmentBtnGreenView, binding.cvRetireeAppointmentPaymentDoc, binding.tvRetireeAppointmentPaymentDocFilename, binding.imgRetireeAppointmentPaymentDocClose, binding.llRetireeAppointmentPaymentDocUploadprogress, binding.llRetireeAppointmentPaymentDocPercentage, binding.pbRetireeAppointmentPaymentDoc)
                DocumentFragmentUtils.setDocumentViewIfPresent(retireeUserDoc.paymentAuthorizationRetirementOrDeathFileUrl, binding.retireeAuthorisationBtnGreenView, binding.cvRetireeAuthorisationPaymentDoc, binding.tvRetireeAuthorisationPaymentDocFilename, binding.imgRetireeAuthorisationPaymentDocClose, binding.llRetireeAuthorisationPaymentDocUploadprogress, binding.llRetireeAuthorisationPaymentDocPercentage, binding.pbRetireeAuthorisationPaymentDoc)
                DocumentFragmentUtils.setDocumentViewIfPresent(retireeUserDoc.clearanceFormFileUrl, binding.retireeClearanceBtnGreenView, binding.cvRetireeClearanceFormDoc, binding.tvRetireeClearanceFormDocFilename, binding.llRetireeClearanceFormUpload, binding.llRetireeClearanceFormDocUploadprogress, binding.llRetireeClearanceFormDocPercentage, binding.pbRetireeClearanceFormDoc)
                DocumentFragmentUtils.setDocumentViewIfPresent(retireeUserDoc.promotionNotificationFileUrl, binding.retireeNotificationBtnGreenView, binding.cvRetireeNotificationPromotionDoc, binding.tvRetireeNotificationPromotionDocFilename, binding.llRetireeNotificationPromotionDocUpload, binding.llRetireeNotificationPromotionDocUploadprogress, binding.llRetireeNotificationPromotionDocPercentage, binding.pbRetireeNotificationPromotionDoc)
                DocumentFragmentUtils.setDocumentViewIfPresent(retireeUserDoc.pensionLifeCertificateFileUrl, binding.retireePensionCertificateBtnGreenView, binding.cvRetireePensionCertificateDoc, binding.tvRetireePensionCertificateDocFilename, binding.imgRetireePensionCertificateDocClose, binding.llRetireePensionCertificateDocUploadprogress, binding.llRetireePensionCertificateDocPercentage, binding.pbRetireePensionCertificateDoc)
                DocumentFragmentUtils.setDocumentViewIfPresent(retireeUserDoc.retirementNoticeFileUrl, binding.retireeRetirementBtnGreenView, binding.cvRetireeRetirementNoticeDoc, binding.tvRetireeRetirementNoticeDocFilename, binding.imgRetireeRetirementNoticeDocClose, binding.llRetireeRetirementNoticeDocUploadprogress, binding.llRetireeRetirementNoticeDocPercentage, binding.pbRetireeRetirementNoticeDoc)
