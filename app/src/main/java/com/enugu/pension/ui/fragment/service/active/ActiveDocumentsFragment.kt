    ...
    private fun populateViews() {
        ActiveUserDocRetrive?.let { activeUserDoc ->
            if (!activeUserDoc.idCardFileUrl.isNullOrEmpty()) {
                ...
                // Mandatory documents
                DocumentFragmentUtils.setDocumentView(activeUserDoc.idCardFileUrl, binding.aIdCardBtnGreenView, binding.cvActiveIdCard, binding.tvActiveIdCardFilename, binding.imgActiveIdCardClose, binding.llActiveIdCardUploadprogress, binding.llActiveIdCardPercentage, binding.pbActiveIdCard)
                // Optional documents
                DocumentFragmentUtils.setDocumentViewIfPresent(activeUserDoc.passportPhotoFileUrl, binding.aPassportPhotoBtnGreenView, binding.cvActivePassportPhoto, binding.tvActivePassportPhotoFilename, binding.imgActivePassportPhotoClose, binding.llActivePassportPhotoUploadprogress, binding.llActivePassportPhotoPercentage, binding.pbActivePassportPhoto)
                DocumentFragmentUtils.setDocumentViewIfPresent(activeUserDoc.applicationFormFileUrl, binding.appFormBtnGreenView, binding.cvActiveAppForm, binding.tvActiveAppFormFilename, binding.imgActiveAppFormClose, binding.llActiveAppFormUploadprogress, binding.llActiveAppFormPercentage, binding.pbActiveAppForm)
                DocumentFragmentUtils.setDocumentViewIfPresent(activeUserDoc.promotionLetterTransferLetterFileUrl, binding.promotionLetterBtnGreenView, binding.cvActivePromotionLetter, binding.tvActivePromotionLetterFilename, binding.imgActivePromotionLetterClose, binding.llActivePromotionLetterUploadprogress, binding.llActivePromotionLetterPercentage, binding.pbActivePromotionLetter)
                DocumentFragmentUtils.setDocumentViewIfPresent(activeUserDoc.clearanceFormFileUrl, binding.aClearenceFormBtnGreenView, binding.cvActiveClearenceForm, binding.tvActiveClearenceFormFilename, binding.imgActiveClearenceFormClose, binding.llActiveClearenceFormUploadprogress, binding.llActiveClearenceFormPercentage, binding.pbActiveClearenceForm)
            }else{
