package com.enugu.pension.data.repository
...
import com.enugu.pension.data.remote.dto.request.InputEinNumber
...
import com.enugu.pension.data.remote.dto.request.StatementRequest
...
import com.enugu.pension.data.remote.dto.response.SwiftCodeVerificationResponse
import com.enugu.pension.data.remote.api.ApiInterface
...
class NetworkRepo(private val apiInterface: ApiInterface) {
    ...
    suspend fun resetPassword(inputResetPassword: com.enugu.pension.data.remote.dto.request.InputResetPassword) =
    ...
    suspend fun fetchBookingSlots(selectedDay: String): com.enugu.pension.data.remote.dto.response.BookingSlotResponse {
    ...
    suspend fun bookAppointment(request: com.enugu.pension.data.remote.dto.request.BookAppointmentRequest) =
    ...
    suspend fun updateProfileDetails(updateProfileForm: com.enugu.pension.data.remote.dto.request.UpdateProfileForm): ProfileUpdateResponse {
