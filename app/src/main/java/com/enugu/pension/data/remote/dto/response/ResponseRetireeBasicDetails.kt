...
data class ResponseRetireeBasicDetails(
	...
	val detail: com.enugu.pension.data.remote.dto.response.RetireeBasicDetail? = null
)
...
data class RetireeBasicDetail(
	...
	val userProfileDetails: com.enugu.pension.data.remote.dto.response.RetireeBasicUserProfileDetails? = null,
