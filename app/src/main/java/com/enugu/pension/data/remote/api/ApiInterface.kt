package com.enugu.pension.data.remote.api


import com.enugu.pension.data.remote.dto.request.*
...
interface ApiInterface {
    ...
    suspend fun getVerifyRegistrationOTP(@Body inputSignupVerify: InputSignupVerify): com.enugu.pension.data.remote.dto.response.VerifyResponse

    @POST("/api/v1/forgot_password_verify")
    suspend fun getVerifyForgotOTP(@Body inputForgotVerify: InputForgotVerify): com.enugu.pension.data.remote.dto.response.VerifyResponse
    ...
    suspend fun getRefreshToken(@Body inputRefreshToken: InputRefreshToken): com.enugu.pension.data.remote.dto.response.ResponseRefreshToken
    ...
    suspend fun getResetPassword(@Body inputResetPassword: com.enugu.pension.data.remote.dto.request.InputResetPassword): ResponseResetPassword
    ...
    ): Call<com.enugu.pension.data.remote.dto.response.ResponseRetireeBasicDetails>
...
// doc upload -eg
    ...
    suspend fun getActiveProcessingVerify(@Header("Authorization") token: String): com.enugu.pension.data.remote.dto.response.ResponseActiveProcessingVerify
    ...
    suspend fun bookAppointment(@Header("Authorization") token: String,@Body request: com.enugu.pension.data.remote.dto.request.BookAppointmentRequest): BookAppointmentResponse

    @POST("/api/v1/booking/create-booking/")
    fun bookAppointmentCall(@Header("Authorization") token: String,@Body request: com.enugu.pension.data.remote.dto.request.BookAppointmentRequest): Call<BookAppointmentResponse>
