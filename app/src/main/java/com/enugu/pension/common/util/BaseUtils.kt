...
import com.enugu.pension.ui.adapter.PopUpAdapter
import com.enugu.pension.ui.dialog.EnguDialog

interface BaseUtils {
    fun provideContext(): Context
    fun provideActivity(): Activity
    fun provideFragmentManager(): FragmentManager
    fun provideLoaderViewModel(): com.enugu.pension.viewmodel.LoaderViewModel
